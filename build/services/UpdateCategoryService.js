...
var UpdateCategoryService = /** @class */ (function () {
    ...
    UpdateCategoryService.prototype.UpdateCategory = function (_a) {
        var id = _a.id, name = _a.name, description = _a.description;
        return __awaiter(this, void 0, void 0, function () {
            var repo, checkCategory;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        repo = data_source_1.AppDataSource.getRepository(Category_1.default);
                        return [4 /*yield*/, repo.find({ where: { id: id } })];
                    case 1:
                        checkCategory = (_b.sent())[0];
                        if (!checkCategory) {
                        ...
                        return [4 /*yield*/, repo.save(checkCategory)];
                    case 2:
                        _b.sent();
                        return [2 /*return*/, checkCategory];
                }
            });
        });
    };
