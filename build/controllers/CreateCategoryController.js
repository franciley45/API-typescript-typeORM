...
var CreateCategoryController = /** @class */ (function () {
    ...
    CreateCategoryController.prototype.createCategory = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, description, service, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, name = _a.name, description = _a.description;
                        service = new CreateCategoryService_1.CreateCategoryService();
                        return [4 /*yield*/, service.createCategory({ name: name, description: description })];
                    case 1:
                        result = _b.sent();
