...
userRouter.get('/', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var users;
...
userRouter.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, users;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, name = _a.name, email = _a.email;
                return [4 /*yield*/, UserService_1.default.createUser(name, email)];
            case 1:
                users = _b.sent();
                return [2 /*return*/, res.status(200).json(users)];
        }
