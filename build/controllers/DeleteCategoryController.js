...
var DeleteCategoryService_1 = require("../services/DeleteCategoryService");
var DeleteCategoryController = /** @class */ (function () {
    function DeleteCategoryController() {
    }
    DeleteCategoryController.prototype.DeleteCategory = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        service = new DeleteCategoryService_1.DeleteCategoryService();
                        return [4 /*yield*/, service.DeleteCategory(id)];
                    case 1:
                        result = _a.sent();
